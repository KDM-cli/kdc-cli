# Contributing to KDC-CLI

First off, thank you for considering contributing to KDC-CLI! It's people like you that make KDC-CLI such a great tool.
...
Before creating bug reports, please check the [issue tracker](https://github.com/KDM-cli/kdc-cli/issues) to see if the problem has already been reported. If it hasn't, please open a new issue.

When reporting a bug, please include:
- Your operating system and version.
- The version of Node.js you are using.
- The version of KDC-CLI you are using.
- Detailed steps to reproduce the bug.
- Any relevant logs or error messages.

### Suggesting Enhancements

If you have an idea to improve KDC-CLI, please open an issue in the [issue tracker](https://github.com/KDM-cli/kdc-cli/issues) and label it as an enhancement (or feature request). Include as much detail as possible about your idea and why it would be beneficial.
...
1. Clone the repository:
   ```bash
   git clone https://github.com/utkarsh232005/kdc-cli.git
   cd kdc-cli
   ```
